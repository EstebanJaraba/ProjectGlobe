...
if ($_POST['accion'] == 'registroCliente') {
    ...
    $query = "INSERT INTO clients (documentClient, nameClient, last_name, email, phone, stateClient) 
    VALUE ('$documentClient', '$nameClient', '$last_name', '$email', '$phone', '$stateClient')";
...
if ($_POST['accion'] == 'editarCliente') {
    ...
    $query = "UPDATE clients SET documentClient = '$documentClient', nameClient = '$nameClient', last_name = '$last_name', email = '$email', phone = '$phone', stateClient = '$stateClient' WHERE idClient = '$idClient'";
