...
function agregarFila_Clientes(idClient, nameClient, last_name, email, phone, stateClient, acciones){
    ...
    let datosClientes = "'"+idClient+"', '"+nameClient+"', '"+last_name+"', '"+email+"', '"+phone+"', '"+stateClient+"'";
...
function tomarDatos(idClient, nameClient, last_name, email, phone, stateClient){
